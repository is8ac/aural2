...
def main():
    ...
    with graph.as_default():
        ...
        with tf.name_scope('training'):
            ...
            print("train_model.zero_state", train_model.zero_state)
    ...
    with tf.Session(graph=graph) as session:
        ...
        session.run(init)
        print(train_model.average_loss.name)
        ...
        # non frozen for training
        tf.train.write_graph(tf.get_default_graph().as_graph_def(), '../tftrain/models', params["vocab_name"] + '_train.pb', as_text=False)
